// filepath: d:\Coisas\estudos\faculdade\ZeLuis\Compiladores\MyCompiler\MyCompiler\src\tokenization.hpp
#pragma once
#include <string>
#include <vector>
#include <optional>
...
class Tokenizer {
public:
    explicit Tokenizer(const std::string& input) : m_input(std::move(input)) {}
