// filepath: d:\Coisas\estudos\faculdade\ZeLuis\Compiladores\MyCompiler\src\main.cpp
#include <iostream>
#include <fstream>
#include <sstream>
#include <optional>
...
int main(int argc, char *argv[]) {
    ...
    std::cout << "Analisador semantico iniciado" << std::endl;
    SemanticAnalyzer semanticAnalyzer;
    semanticAnalyzer.analyze(syntaxTree);
    std::cout << "Analisador semantico finalizado" << std::endl;
